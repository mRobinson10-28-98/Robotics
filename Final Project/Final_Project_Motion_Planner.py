...
def motion_iterator(motion_planner):
    ...
    # mdkp is same as manipdkin except assumes point is followed a certain nnumber of joint axes
    for index in range(1, len(baxter_initial_config_points)):
        point = baxter_initial_config_points[index]
        initial_points.append(mdkp(point, axis_joints, q_joints, type_joints, motion_planner.config, index))
    ...
    x_axis_initial = mdkp(x_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
    y_axis_initial = mdkp(y_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
    z_axis_initial = mdkp(z_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
    ...
    for index in range(1,len(baxter_initial_config_points)):
        point = baxter_initial_config_points[index]
        final_points.append(mdkp(point, axis_joints, q_joints, type_joints, motion_planner.config, index))
    ...
    x_axis_final = mdkp(x_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
    y_axis_final = mdkp(y_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
    z_axis_final = mdkp(z_axis, axis_joints, q_joints, type_joints, motion_planner.config, 7)
...
g_turn = np.matmul(g_handle, g_turn)
